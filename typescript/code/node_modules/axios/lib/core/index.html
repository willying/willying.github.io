...
<ul><li>Requests sent via <code>adapters/</code> (see lib/adapters/README.md)</li></ul></li> <li>Managing interceptors</li> <li>Handling config</li></ul></div> <footer class="page-edit"><!----> <!----></footer> <!----> </main></div><div class="global-ui"><!----></div></div>
    <script src="/assets/js/app.77adc610.js" defer></script><script src="/assets/js/2.ccf48b6a.js" defer></script><script src="/assets/js/1.87595a30.js" defer></script><script src="/assets/js/45.bf2f36c1.js" defer></script>
  </body>
</html>
